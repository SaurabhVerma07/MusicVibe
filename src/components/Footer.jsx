    ...
    <footer className="footer-modern">
        ...
        <div className="footer-brand">
          ...
          <div className="social-media-section">
            ...
            <div className="social-links-modern">
              ...
              <a href="#" className="social-btn spotify" aria-label="Spotify">
                <i className="fab fa-spotify"></i>
                <span>Spotify</span>
              </a>
              <a href="#" className="social-btn discord" aria-label="Discord">
      ...
      <div className="footer-bottom-modern">
        <div className="footer-bottom-content">
          <p>&copy; 2024 Jamify. All rights reserved. Made with <i className="fas fa-heart"></i> for music lovers</p>
