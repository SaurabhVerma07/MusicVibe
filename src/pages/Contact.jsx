          ...
          <div className="contact-info-section">
            <div className="info-card">
              ...
              <div className="info-item">
                ...
                <div className="info-details">
                  <h3>Email</h3>
                  <p>support@jamify.com<br />info@jamify.com</p>
                </div>
              </div>
              ...
              <div className="social-links">
                ...
                <div className="social-icons">
                  ...
                  <a href="#" className="social-icon spotify" onClick={(e) => e.preventDefault()}>
        ...
        <div className="faq-section">
          ...
          <div className="faq-grid">
            ...
            <div className="faq-item">
              <div className="faq-question">
                <i className="fas fa-question-circle"></i>
                <h3>Is Jamify free to use?</h3>
              </div>
              <p>Yes! Jamify offers a free tier with access to thousands of songs. Premium features are also available.</p>
            </div>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-section-contact">
            ...
            <p><i className="fas fa-envelope"></i> support@jamify.com</p>
          </div>
        </div>
        <div className="footer-bottom">
          <p>© 2025 Jamify Music. All Rights Reserved.</p>
        </div>
      </footer>
    </>
  )
